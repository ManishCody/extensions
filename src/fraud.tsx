  ...
  return (
    <div className="fraud-detection-container">
      <div className="logo-section">
        <div className="logo" onClick={() => setStatusEnabled(!statusEnabled)}>
          <img src="/main-logo.png" className="logo" alt="" style={{ filter: statusEnabled ? "none" : "grayscale(1)" }} />
        </div>
      </div>
        ...
        <div className="toggle-list">
          <div className="toggle-item">
            ...
            <label className="switch">
              <input type="checkbox" checked={statusEnabled} onChange={() => setStatusEnabled(!statusEnabled)} />
          ...
          <div className="toggle-item">
            ...
            <label className="switch">
              <input type="checkbox" checked={hideFakePosts} onChange={() => setHideFakePosts(!hideFakePosts)} />
              <span className="slider"></span>
            </label>
          </div>
